...
def run_ocr(file_path: str) -> List[Dict[str, Any]]:
    ...
    -------
    List[Dict[str, Any]]
        A list of OCR results ready for field extraction.  If
        extraction fails, the list is empty.
    """
    ...
    try:
        ...
        logger.error(f"❌ Error in Tesseract OCR processing: {e}")
        # Any errors in OCR processing result in an empty output
        return []
