...
# from app.invoices_page import render_invoices_page  # Removed, now handled in React
...
#     st.info("The Invoices page has moved to the new React UI. Please visit http://localhost:3000/invoices")
