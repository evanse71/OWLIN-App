      ...
      <div className="sticky top-6">
        ...
        {invoices.length === 0 ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-500 mb-1">No unpaired invoices</p>
          ...
          <div className="space-y-3 max-h-[calc(100vh-200px)] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
            {unpairedInvoices.map((invoice) => (
              <div
                key={invoice.id}
                className="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:border-gray-300 transition-colors duration-200 cursor-pointer group"
