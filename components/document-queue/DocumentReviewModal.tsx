...
import { DocumentQueueItem, ReviewData, EscalationData } from '@/services/api';
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {document.document_type_guess.replace('_', ' ').toUpperCase()} • {Math.round(document.confidence * 100)}% confidence
            </p>
          </div>
          <button
            onClick={onClose}
